...
#include "../sserver_base/WeakCallback.h"
#include "Channel.h"
#include "EventLoop.h"
#include "Socket.h"
...
void sserver::net::defaultConnectionCallback(const TcpConnectionPtr &conn)
...
void sserver::net::defaultMessageCallback(const TcpConnectionPtr &,
                                          Buffer *buf,
                                          Timestamp)
