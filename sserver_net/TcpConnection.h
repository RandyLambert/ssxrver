...
#ifndef SSERVER_TCPCONNECTION_H
#define SSERVER_TCPCONNECTION_H
...
typedef std::shared_ptr<TcpConnection> TcpConnectionPtr; //使用shared_ptr来管理

} // namespace net
} // namespace sserver

#endif // SSERVER_TCPCONNECTION_H
